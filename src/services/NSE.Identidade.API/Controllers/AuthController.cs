...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Login(UsuarioLogin usuarioLogin)
        {
            ...
            {
                AdicionarErroProcessamento("Usuário temporariamente bloqueado por tentaivas inválidas");
                return CustomResponse();
            }
        ...
        private UsuarioRespostaLogin ObterRepostaToken(string encodedToken, IdentityUser user, IList<Claim> claims)
        {
